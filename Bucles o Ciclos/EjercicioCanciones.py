...
for indice in range(0,5,1): #El for sirve para elementos iterables. Lo mas importante es el range, genera una secuencia de numeros enteros y se lo asigna a la varibale para así después ejecutar el bloque de código.
